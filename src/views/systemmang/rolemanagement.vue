    ...
    <div class="app-container">
       ...
       <div class="filter-container suppliertoolbar">
           <el-row :gutter="20" class="mt10">
               <label class="el-form-item__label">角色名称:</label>
               <el-input @keyup.enter.native="handleFilter" v-model="listQuery.supplierName" style="width: 200px;" class="filter-item" placeholder="请输入角色名称" clearable></el-input>
               <label class="el-form-item__label">角色代码:</label>
               <el-input @keyup.enter.native="handleFilter" v-model="listQuery.supplierBH" style="width: 200px;" class="filter-item" placeholder="请输入角色代码" clearable></el-input>
        ...
        <el-table :data="supplierlistary" @selection-change="selsChange" v-loading.body="listLoading" ref="multipleTable" element-loading-text="拼命加载中..." fit highlight-current-row style="width: 100%">
            ...
            <el-table-column align="center" prop="supplierName" label="角色名称" style="width: 10%"></el-table-column>
            <el-table-column align="center" prop="supplierBH" label="角色代码" style="width: 15%"></el-table-column>
            <el-table-column align="center" prop="supplierYWLX" label="角色描述" style="width: 15%"></el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="right" label-width="130px">
                <el-row :gutter="40">
                    <el-col :span="12">
                        <el-form-item label="角色名称:" prop="supplierName">
                            <el-input v-model="temp.supplierName"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="角色代码:" prop="supplierBH">
                            <el-input v-model="temp.supplierBH"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="角色描述:" prop="supplierYWLX">
                            <el-input type="textarea" :rows="2" v-model="temp.supplierYWLX"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
...
export default {
    ...
    data () {
        return {
            ...
            rules: {
                supplierBH: [{ required: true, message: '角色代码必填', trigger: 'blur' }],
                supplierName: [{ required: true, message: '角色名称必填', trigger: 'blur' }]
            },
            data2: [{
                id: 1,
                label: '飞机购买',
