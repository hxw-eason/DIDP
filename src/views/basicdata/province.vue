    ...
    <div class="app-container">
       ...
       <div class="filter-container suppliertoolbar">
           <el-row :gutter="20" class="mt10">
               <label class="el-form-item__label">省份编码:</label>
               <el-input @keyup.enter.native="handleFilter" v-model="listQuery.countryNumber" style="width: 160px;" class="filter-item" placeholder="请输入省份编码" clearable></el-input>
               <label class="el-form-item__label">省份中文名称:</label>
               <el-input @keyup.enter.native="handleFilter" v-model="listQuery.provinceName" style="width: 160px;" class="filter-item" placeholder="请输入省份中文名" clearable></el-input>
               <label class="el-form-item__label">省份英文名称:</label>
               <el-input @keyup.enter.native="handleFilter" v-model="listQuery.countryEingshName" style="width: 160px;" class="filter-item" placeholder="请输入省份英文名" clearable></el-input>
               <label class="el-form-item__label">所属航区:</label>
               <el-select class="filter-item" style="width: 100px" v-model="listQuery.cooperationType" placeholder="请选择">
        ...
        <el-table :data="supplierlistary" @selection-change="selsChange" v-loading.body="listLoading" ref="multipleTable" element-loading-text="拼命加载中..." fit highlight-current-row style="width: 100%">
            ...
            <el-table-column align="center" label="省份编码" >
                <template slot-scope="scope">
                    <span>{{scope.row.countryNumber}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="省份中文名称" >
                 <template slot-scope="scope">
                    <span>{{scope.row.provinceName}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" prop="countryEingshName" label="省份英文名称"></el-table-column>
            <el-table-column align="center" prop="cooperationType" label="所属航区" >
                <template slot-scope="scope">
